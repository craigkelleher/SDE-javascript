...
*/
random_quote_btn.onclick = () => {
let newP = document.createElement("p")
newP.innerText = pickRandomQuote(inspirationalQuotes);
document.getElementById("quotes_container").appendChild(newP);
//^ equiv to: quotes_container.appendChild(p);
